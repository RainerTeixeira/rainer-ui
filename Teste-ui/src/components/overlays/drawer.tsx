...
export default function Drawer() {
  ...
  return (
    <div>
      <Button label="Abrir drawer" variant="outline" onClick={() => setOpen(true)} />

      {open ? (
        <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-label="Drawer">
          <div className="absolute inset-0" style={{ backgroundColor: 'rgba(0,0,0,0.45)' }} onClick={() => setOpen(false)} />
          <div
            className="absolute right-0 top-0 h-full w-full max-w-sm border-l"
          ...
          >
            <div className="p-5 space-y-3">
              ...
              <p className="text-xs" style={{ color: 'var(--color-text-secondary)' }}>
                Um drawer é um painel lateral para ações secundárias ou detalhes.
              </p>
              <div
