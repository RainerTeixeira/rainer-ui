...
function CompliancePage() {
  return (
    <div className="space-y-6">
      ...
      <Quote
        message="Criamos componentes com foco em acessibilidade e consistência."
        author="Equipe Rainersoft"
        role="UI Library"
      />
      <QuoteTestimonial
        message="A biblioteca Rainersoft UI facilita criar interfaces consistentes e acessíveis."
        author="Designer de Produto"
        role="UI/UX"
      />
      <div className="space-y-3">
        <h2 className="text-lg font-semibold">Atalhos</h2>
        <KbdCombo keys={["Ctrl", "K"]} label="Abrir busca" />
        <Kbd>Esc</Kbd>
      </div>
    </div>
  )
    ...
    <div className="min-h-screen bg-[var(--color-background-primary)] text-[var(--color-text-primary)]">
      <header className="border-b border-[var(--color-gray-600)] bg-[var(--color-background-secondary)]">
        <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
          ...
          <span className="text-sm text-[var(--color-text-secondary)]">Rotas separadas por seção</span>
        </div>
      </header>
