...
const segmentedControlVariants = (0, import_class_variance_authority.cva)(
        ...
        children: options.map((option) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              ...
              children: [
                option.icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-4 w-4", children: option.icon }),
  ...
  ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        ...props,
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-4 w-4", children: icon }),
          children
        ]
      }
    );
