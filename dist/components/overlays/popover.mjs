...
import { Portal, Content, Root, Trigger } from '@radix-ui/react-popover';
...
var PopoverContent = React.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx(Portal, { children: /* @__PURE__ */ jsx(
  Content,
  {
    ref,
    align,
