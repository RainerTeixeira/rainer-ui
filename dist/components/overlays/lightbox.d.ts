 ...
 * Props do Lightbox
 */
export interface LightboxProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof lightboxVariants> {
    /** Itens da lightbox */
    items: LightboxItem[];
 ...
 * ```
 */
export declare const Lightbox: React.ForwardRefExoticComponent<LightboxProps & React.RefAttributes<HTMLDivElement>>;
export {};
