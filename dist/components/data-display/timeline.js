...
var TimelineItem = React__namespace.forwardRef(
  ({
    className,
    status = "default",
    icon,
    ...
    if (!IconComponent && iconType) {
      IconComponent = React__namespace.createElement(defaultIcons[iconType], {
...
var TimelineSeparator = React__namespace.forwardRef(
