...
var Sidebar = React2.forwardRef(
  ({
    ...
    const [internalCollapsed, setInternalCollapsed] = React2.useState(collapsed);
    const [internalOpen, setInternalOpen] = React2.useState(open);
    const isCollapsed = onCollapse ? collapsed : internalCollapsed;
    const isOpen = overlay ? onOpenChange ? open : internalOpen : true;
    const handleCollapse = React2.useCallback(() => {
      if (onCollapse) {
