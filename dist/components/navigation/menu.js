...
var Menu = React2__namespace.forwardRef(
  ({
    className,
    variant = "default",
    size = "md",
    ...
    const [internalOpen, setInternalOpen] = React2__namespace.useState(false);
    const [openSubmenus, setOpenSubmenus] = React2__namespace.useState(/* @__PURE__ */ new Set());
    ...
    const toggleSubmenu = React2__namespace.useCallback((itemId) => {
...
var MenuBar = React2__namespace.forwardRef(
  ({
    className,
    menus,
    ...props
...
var NavigationContextMenu = React2__namespace.forwardRef(
  ({
    className,
    children,
    items,
    ...
    const [position, setPosition] = React2__namespace.useState({ x: 0, y: 0 });
    const containerRef = React2__namespace.useRef(null);
    const handleContextMenu = React2__namespace.useCallback((event) => {
