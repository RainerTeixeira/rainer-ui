...
var Menu = React__namespace.forwardRef(
  ({
    className,
    variant = "default",
    size = "md",
    ...
    const [openSubmenus, setOpenSubmenus] = React__namespace.useState(/* @__PURE__ */ new Set());
    ...
    const toggleSubmenu = React__namespace.useCallback((itemId) => {
...
var MenuBar = React__namespace.forwardRef(
  ({
    className,
    menus,
    ...props
...
var NavigationContextMenu = React__namespace.forwardRef(
  ({
    className,
    children,
    items,
    ...
    const containerRef = React__namespace.useRef(null);
    const handleContextMenu = React__namespace.useCallback((event) => {
