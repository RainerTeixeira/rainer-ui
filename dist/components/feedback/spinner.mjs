...
var SpinnerOverlay = React.forwardRef(
  ({
    className,
    fullscreen = false,
...
var DotsSpinner = React.forwardRef(
  ({
    className,
    count = 3,
    size = "md",
...
var PulseSpinner = React.forwardRef(
  ({
    className,
    rings = 3,
    size = "md",
...
export { DotsSpinner, PulseSpinner, Spinner, SpinnerOverlay };
