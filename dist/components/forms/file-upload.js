...
var FileUpload = React__namespace.forwardRef(
  ({
    ...
    const processFiles = React__namespace.useCallback((fileList) => {
    ...
    const handleFileSelect = React__namespace.useCallback((e) => {
    ...
    const handleRemoveFile = React__namespace.useCallback((id) => {
      onFileRemove?.(id);
    }, [onFileRemove]);
