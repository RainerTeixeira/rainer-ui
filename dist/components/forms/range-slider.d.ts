 ...
 */
interface RangeSliderProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'value' | 'onChange' | 'defaultValue'>, VariantProps<typeof rangeSliderVariants> {
    /** Valor atual */
    value?: RangeValue;
    /** Valor inicial */
...
export { RangeSlider, type RangeSliderProps, type RangeValue };
