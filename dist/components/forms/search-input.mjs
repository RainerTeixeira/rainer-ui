...
var SearchInput = React2.forwardRef(
  ({
    ...
    const [selectedIndex, setSelectedIndex] = React2.useState(-1);
    const [filteredSuggestions, setFilteredSuggestions] = React2.useState([]);
    ...
    const handleSuggestionClick = React2.useCallback((suggestion) => {
      if (suggestion.action) {
        suggestion.action();
      } else {
        setValue(suggestion.text);
