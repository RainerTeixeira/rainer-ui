...
var PhoneInput = React2.forwardRef(
  ({
    ...
    const [isDropdownOpen, setIsDropdownOpen] = React2.useState(false);
    ...
    const handleInputChange = React2.useCallback((event) => {
    ...
    const handleCountrySelect = React2.useCallback((country2) => {
