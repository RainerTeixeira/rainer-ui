...
Kbd.displayName = "Kbd";
var KbdCombo = React3.forwardRef(
  ({
    className,
    keys,
    separator = "+",
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        ...props,
        children: keys.map((key, index) => /* @__PURE__ */ jsxs(React3.Fragment, { children: [
...
var Code = React3.forwardRef(
  ({
    ...
    const codeRef = React3.useRef(null);
...
var CodeInline = React3.forwardRef(
  ({
    className,
    color = "default",
    ...props
...
var QuoteTestimonial = React3.forwardRef(
  ({
    className,
    author,
    source,
...
var QuoteBlock = React3.forwardRef(
  ({
    className,
    children,
    ...props
...
export { Code, CodeBlock, CodeInline, Kbd, KbdCombo, KeyboardShortcuts, Quote, QuoteBlock, QuoteTestimonial };
