...
var Avatar = React18__namespace.forwardRef(
  ({
    ...
    const [imageStatus, setImageStatus] = React18__namespace.useState("loading");
    const [showFallback, setShowFallback] = React18__namespace.useState(!src);
...
var Input = React18__namespace.forwardRef(
  ({ className, type, error, helperText, label, required, id, ...props }, ref) => {
    const inputId = id || `input-${React18__namespace.useId()}`;
...
var Textarea = React18__namespace.forwardRef(
  ({
    ...
    const inputId = id || `textarea-${React18__namespace.useId()}`;
    const [characterCount, setCharacterCount] = React18__namespace.useState(0);
    React18__namespace.useEffect(() => {
...
var Slider = React18__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsxs(
...
var IconButton = React18__namespace.forwardRef(
  ({
    className,
    variant = "default",
    size = "md",
    ...
    const [showTooltip, setShowTooltip] = React18__namespace.useState(false);
    const [tooltipVisible, setTooltipVisible] = React18__namespace.useState(false);
...
var LinkButton = React18__namespace.forwardRef(
  ({
    className,
    variant = "default",
    size = "md",
...
var FAB = React18__namespace.forwardRef(
  ({
    ...
    const [showActions, setShowActions] = React18__namespace.useState(active);
...
FAB.displayName = "FAB";
var FABGroup = React18__namespace.forwardRef(
  ({
    className,
    main,
    secondary = [],
...
var SegmentedControl = React18__namespace.forwardRef(
  ({
    className,
    size = "md",
    variant = "default",
    ...
    const [internalValue, setInternalValue] = React18__namespace.useState(defaultValue || options[0]?.value);
    const currentValue = value !== void 0 ? value : internalValue;
    const handleOptionClick = React18__namespace.useCallback((optionValue, isDisabled) => {
...
var SegmentedControlItem = React18__namespace.forwardRef(
  ({
    className,
    active = false,
    size = "md",
...
var Card = React18__namespace.forwardRef(({ className, variant = "default", ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
    className: cn(
...
var Progress = React18__namespace.forwardRef(({ className, value, color = "default", ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
...
var QuickStats = React18__namespace.default.memo(QuickStatsComponent);
...
var Card2 = React18__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
    className: cn(
...
var CardHeader2 = React18__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
...
var CardTitle2 = React18__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "h3",
  {
    ref,
    className: cn(
...
var CardDescription2 = React18__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "p",
  {
    ref,
...
var CardContent2 = React18__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx("div", { ref, className: cn("p-6 pt-0", className), ...props }));
CardContent2.displayName = "CardContent";
var CardFooter2 = React18__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
...
var HighlightCard = React18__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
    className: cn(
