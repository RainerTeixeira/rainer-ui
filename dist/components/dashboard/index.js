...
var Input = React19__namespace.forwardRef(
  ({ className, type, error, helperText, label, required, id, ...props }, ref) => {
    const inputId = id || `input-${React19__namespace.useId()}`;
...
var Textarea = React19__namespace.forwardRef(
  ({
    ...
    const inputId = id || `textarea-${React19__namespace.useId()}`;
    const [characterCount, setCharacterCount] = React19__namespace.useState(0);
    React19__namespace.useEffect(() => {
...
var ButtonComponent = React19__namespace.forwardRef(
  ({
    className,
    variant,
    size,
...
var IconButton = React19__namespace.forwardRef(
  ({
    ...
    const [tooltipVisible, setTooltipVisible] = React19__namespace.useState(false);
...
var Card = React19__namespace.forwardRef(({ className, variant = "default", ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
    className: cn(
...
var Progress = React19__namespace.forwardRef(({ className, value, color = "default", ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
...
var TokensContext = React19__namespace.createContext(null);
function useTokens() {
  const context = React19__namespace.useContext(TokensContext);
  if (!context) {
    throw new Error(
...
var QuickStats = React19__namespace.default.memo(QuickStatsComponent);
...
var Card2 = React19__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
    className: cn(
...
var CardHeader2 = React19__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
...
var CardTitle2 = React19__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "h3",
  {
    ref,
    className: cn(
...
var CardDescription2 = React19__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "p",
  {
    ref,
...
var CardContent2 = React19__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx("div", { ref, className: cn("p-6 pt-0", className), ...props }));
CardContent2.displayName = "CardContent";
var CardFooter2 = React19__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ref,
