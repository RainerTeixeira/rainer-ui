  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6", children: stats.map((stat, index) => /* @__PURE__ */ jsx(React__default.Fragment, { children: renderStatCard(stat, index) }, `${stat.label}-${index}`)) }),
...
export { QuickStats, quick_stats_default as default };
//# sourceMappingURL=quick-stats.mjs.map
//# sourceMappingURL=quick-stats.mjs.map