...
// src/lib/adapters/rainersoft.ts
var rainersoftTokens = null;
var rainersoftLightColors = null;
var rainersoftDarkColors = null;
try {
  const designTokens = __require("@rainersoft/design-tokens");
  if (designTokens?.tokens) {
    rainersoftTokens = designTokens.tokens;
  }
...
function mapThemeToColors(theme) {
...
var rainersoftAdapter = rainersoftTokens ? {
  name: "rainersoft",
  version: "2.6.0",
...
var createRainersoftAdapter = (options) => {
  if (!rainersoftTokens) {
    console.warn(
      "[@rainersoft/ui] @rainersoft/design-tokens n\xE3o encontrado. Usando tokens gen\xE9ricos. Instale com: pnpm add @rainersoft/design-tokens"
    );
...
var isRainersoftAvailable = () => rainersoftTokens !== null;

exports.FALLBACK_TOKENS = GENERIC_TOKENS;
exports.createRainersoftAdapter = createRainersoftAdapter;
exports.isRainersoftAvailable = isRainersoftAvailable;
exports.rainersoftAdapter = rainersoftAdapter;
//# sourceMappingURL=rainersoft.js.map
//# sourceMappingURL=rainersoft.js.map