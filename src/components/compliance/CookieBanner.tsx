...
// Componentes faltantes criados localmente
...
// Tipos locais para evitar dependências complexas
...
// Implementação simplificada local
...
// Exportar hook para uso em outros componentes
// (useCookieConsent já está exportado acima)
