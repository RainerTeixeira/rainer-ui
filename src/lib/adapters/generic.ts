...
const GENERIC_TOKENS: DesignTokens = {
  primitives: {
    colors: {
      cyan: {
        50: '#ecfeff',
...
export const genericAdapter: AdapterConfig = {
  name: 'generic',
  version: '1.0.0',
...
export const createGenericAdapter: AdapterFactory = (options) => {
  return {
    ...genericAdapter,
